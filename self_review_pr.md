...
- テストの品質と意図の評価（テストカバレッジの数値は結果指標であり、目標ではない）:
...
Pull Request修正前から存在していた問題への対応指針:
- このPull Requestの修正前からそもそもこうなっていた問題は、修正が難しい場合があります
- そういった修正まで1つのPull Requestに押し込むと、レビューが大変になります
- 課題点としては指摘しつつ、別のPull Requestで対応したほうが良いこととして提案に留めましょう
- ただし、修正が大変だからという理由で、後続のPull Requestに安易に後回しにすることは避けてください
